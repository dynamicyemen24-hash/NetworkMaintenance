...
$arguments = "-NoProfile -ExecutionPolicy Bypass -File `"C:\NetworkMaintenance\Elias_NextGen_System_Care.ps1`""
...
Write-Host "Features: Modular Architecture | Standardized Methodology" -ForegroundColor Cyan